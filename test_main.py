...
input_embeddings, input_im_list = register_user(frmodel, video_path)
...
if __name__ == "__main__":
    ...
    truth_segmentwise = truths_per_segment(labels_path) 
    plot_segments(segments, truth_segmentwise)
    print("\n\n*****RESULTS*****")
    acc,prec,rec,f1 = get_accuracy(truth_segmentwise, det_segmentwise)